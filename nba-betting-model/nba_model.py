...
OU_SCALE = 14.0                # logistic scale for O/U edge (≈1 SD in NBA total pts)
...
class BettingAnalyzer:
    ...
    def analyze_game(self, game, home_stats, away_stats):
        ...
        if game.get("spread") is not None:
            ...
            # (scale=10 calibrated to NBA: spread of 10 ≈ 73%).
        ...
        if game.get("over_under") is not None:
            ...
            # OU_SCALE ≈ 1 SD of total-points variance in NBA basketball.
